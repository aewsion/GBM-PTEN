...
global npde node nx singular m xmesh xi xim zxmp1 xzmp1
  ...
  %   for the ODE system.
    ...
    Ux11=Ux1(1:npde,1);
    U=U1;
    [cL,fL,sL] = feval(pdex4pde,xi(1),tnow,U,Ux11,varargin{:});


    %  Evaluate the boundary conditions
    [pL,qL,pR,qR] = feval(pdex4bc,xmesh(1),u(:,1),xmesh(nx),u(:,nx),tnow,varargin{:});
