...
q=fi_n*(1-exp(-(D_d*(n*pi/L)^2+eta_d)*t))/(D_d*(n*pi/L)^2+eta_d)+2*eta_d*C_d*(L/n/pi)*(-1)^n/(D_d*(n*pi/L)^2+eta_d)*(t+(exp(-(D_d*(n*pi/L)^2+eta_d)*t)-1)/(D_d*(n*pi/L)^2+eta_d));
end
%第二部分
function q = A_1(x,t)
global d_max
...
% d_initial=d_max/L;%初始条件为d_initial*r--x的意思，所以应该要除以100
fi_n=(2*C_d*L/n/pi*(-1)^(n+1)+4*C_d*L/(n*pi)^3*((-1)^n-1)+C_d*(2*L)/n/pi*(-1)^n);
q1=fi_n*(1-exp(-(D_d*(n*pi/L)^2+eta_d)*t))/(D_d*(n*pi/L)^2+eta_d);
q2=2*eta_d*C_d*(L/n/pi)*(-1)^n/(D_d*(n*pi/L)^2+eta_d)*(t+(exp(-(D_d*(n*pi/L)^2+eta_d)*t)-1)/(D_d*(n*pi/L)^2+eta_d));
q3=eta_d*C_d*(D_d*(n*pi/L)^2+eta_d)*L/(n*pi)*(-1)^n/((D_d*(n*pi/L)^2+eta_d)^2+w^2)*(1-cos(w*t))/w;
q4=-eta_d*C_d*L/(n*pi)*(-1)^n/((D_d*(n*pi/L)^2+eta_d)^2+w^2)*sin(w*t);
q5=eta_d*C_d*w*L/(n*pi)*(-1)^n/((D_d*(n*pi/L)^2+eta_d)^2+w^2)*(1-exp(-(D_d*(n*pi/L)^2+eta_d)*t))/(D_d*(n*pi/L)^2+eta_d);
q6=C_d*(D_d*(n*pi/L)^2+eta_d)*L/(n*pi)*(-1)^n/((D_d*(n*pi/L)^2+eta_d)^2+w^2)*sin(w*t);
q7=-C_d*w*(D_d*(n*pi/L)^2+eta_d)*L/(n*pi)*(-1)^n/((D_d*(n*pi/L)^2+eta_d)^2+w^2)*(1-exp(-(D_d*(n*pi/L)^2+eta_d)*t))/(D_d*(n*pi/L)^2+eta_d);
q8=C_d*w*L/(n*pi)*(-1)^n/((D_d*(n*pi/L)^2+eta_d)^2+w^2)*(1-cos(w*t));
...
T=2*period1;
d=inter1;
q1=2*eta_d*L*(-1)^n/(n*pi)*m0/(D_d*(n*pi/L)^2+eta_d);
q2=s+exp(-(D_d*(n*pi/L)^2+eta_d)*(s-k*T))/(D_d*(n*pi/L)^2+eta_d);
q=q1*q2;
end
...
T=2*period1;
d=inter1;
q0=2*eta_d*L*(-1)^n/(n*pi);
q11=m0/d^2*((s-(k+1/2)*T)^3+1/(2*d)*(s-(k+1/2)*T)^4);
q12=m0*exp(-(D_d*(n*pi/L)^2+eta_d)*(s-(k+1/2)*T+d))/(D_d*(n*pi/L)^2+eta_d);
q1=(q11+q12)/(D_d*(n*pi/L)^2+eta_d);
...
q32=-6*m0/d^2*exp(-(D_d*(n*pi/L)^2+eta_d)*(s-(k+1/2)*T+d))/(D_d*(n*pi/L)^2+eta_d);
q3=(q31+q32)/(D_d*(n*pi/L)^2+eta_d)^3;
q41=-12*m0/d^3*(exp(-(D_d*(n*pi/L)^2+eta_d)*(s-(k+1/2)*T+d))/(D_d*(n*pi/L)^2+eta_d)+s);
...
q32=6*m0/d^2*exp(-(D_d*(n*pi/L)^2+eta_d)*(s-(k+1)*T+d))/(D_d*(n*pi/L)^2+eta_d);
q3=(q31+q32)/(D_d*(n*pi/L)^2+eta_d)^3;
q41=12*m0/d^3*(s+exp(-(D_d*(n*pi/L)^2+eta_d)*(s-(k+1)*T+d))/(D_d*(n*pi/L)^2+eta_d));
q4=q41/(D_d*(n*pi/L)^2+eta_d)^4;
q=q0*(q1+q2+q3+q4);
end
...
q22=-6*m0/d^2*exp(-(D_d*(n*pi/L)^2+eta_d)*(s-(k+1/2)*T+d))/(D_d*(n*pi/L)^2+eta_d);
q2=-(q21+q22)/(D_d*(n*pi/L)^2+eta_d)^2;
q31=12*m0/d^3*(s+exp(-(D_d*(n*pi/L)^2+eta_d)*(s-(k+1/2)*T+d))/(D_d*(n*pi/L)^2+eta_d));
...
q22=-6*m0/d^2*exp(-(D_d*(n*pi/L)^2+eta_d)*(s-(k+1)*T+d))/(D_d*(n*pi/L)^2+eta_d);
q2=(q21+q22)/(D_d*(n*pi/L)^2+eta_d)^2;
q31=12*m0/d^3*(s+exp(-(D_d*(n*pi/L)^2+eta_d)*(s-(k+1)*T+d))/(D_d*(n*pi/L)^2+eta_d));
q3=-q31/(D_d*(n*pi/L)^2+eta_d)^3;
q=q0*(q1+q2+q3);
end
...
T=2*period1;
d=inter1;
q1=2*eta_d*L*(-1)^n/(n*pi)*m0/(D_d*(n*pi/L)^2+eta_d)^2;
q2=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-k*T))-exp(-(D_d*(n*pi/L)^2+eta_d)*(s-(k+1/2)*T+d));
q=q1*q2;
end
...
d=inter1;
q0=2*eta_d*L*(-1)^n/(n*pi);
q11=m0*exp(-(D_d*(n*pi/L)^2+eta_d)*(s-(k+1/2)*T+d));
q1=q11/(D_d*(n*pi/L)^2+eta_d)^2;
q21=6*m0/d^2*exp(-(D_d*(n*pi/L)^2+eta_d)*(s-(k+1/2)*T));
q22=6*m0/d^2*exp(-(D_d*(n*pi/L)^2+eta_d)*(s-(k+1/2)*T+d));
q2=-(q21+q22)/(D_d*(n*pi/L)^2+eta_d)^4;
q31=12*m0/d^3*(exp(-(D_d*(n*pi/L)^2+eta_d)*(s-(k+1/2)*T+d))-exp(-(D_d*(n*pi/L)^2+eta_d)*(s-(k+1/2)*T)));
q3=-q31/(D_d*(n*pi/L)^2+eta_d)^5;
q=q0*(q1+q2+q3);
end
...
d=inter1;
q0=2*eta_d*L*(-1)^n/(n*pi);
q11=m0*exp(-(D_d*(n*pi/L)^2+eta_d)*(s-(k+1)*T));
q1=-q11/(D_d*(n*pi/L)^2+eta_d)^2;
q21=6*m0/d^2*exp(-(D_d*(n*pi/L)^2+eta_d)*(s-(k+1)*T+d));
q22=6*m0/d^2*exp(-(D_d*(n*pi/L)^2+eta_d)*(s-(k+1)*T));
q2=(q21+q22)/(D_d*(n*pi/L)^2+eta_d)^4;
q31=12*m0/d^3*(exp(-(D_d*(n*pi/L)^2+eta_d)*(s-(k+1)*T))-exp(-(D_d*(n*pi/L)^2+eta_d)*(s-(k+1)*T+d)));
q3=-q31/(D_d*(n*pi/L)^2+eta_d)^5;
q=q0*(q1+q2+q3);
end
...
d=inter1;
q0=2*L*(-1)^n/(n*pi);
q11=6*m0/d^2*exp(-(D_d*(n*pi/L)^2+eta_d)*(s-(k+1/2)*T));
q12=6*m0/d^2*exp(-(D_d*(n*pi/L)^2+eta_d)*(s-(k+1/2)*T+d));
q1=(q11+q12)/(D_d*(n*pi/L)^2+eta_d)^3;
q21=12*m0/d^3*(exp(-(D_d*(n*pi/L)^2+eta_d)*(s-(k+1/2)*T))-exp(-(D_d*(n*pi/L)^2+eta_d)*(s-(k+1/2)*T+d)));
q2=-q21/(D_d*(n*pi/L)^2+eta_d)^4;
q=q0*(q1+q2);
end
...
d=inter1;
q0=2*L*(-1)^n/(n*pi);
q11=6*m0/d^2*exp(-(D_d*(n*pi/L)^2+eta_d)*(s-(k+1)*T));
q12=6*m0/d^2*exp(-(D_d*(n*pi/L)^2+eta_d)*(s-(k+1)*T+d));
q1=-(q11+q12)/(D_d*(n*pi/L)^2+eta_d)^3;
q21=12*m0/d^3*(exp(-(D_d*(n*pi/L)^2+eta_d)*(s-(k+1)*T))-exp(-(D_d*(n*pi/L)^2+eta_d)*(s-(k+1)*T+d)));
q2=q21/(D_d*(n*pi/L)^2+eta_d)^4;
q=q0*(q1+q2);
end
...
q5=fi_n*(1-exp(-(D_d*(n*pi/L)^2+eta_d)*t))/(D_d*(n*pi/L)^2+eta_d);
q=q4+q5;
end
%第三部分
function q = A_3(x,t)
...
q12=s+exp(-(D_d*(n*pi/L)^2+eta_d)*s)/(D_d*(n*pi/L)^2+eta_d);
q=q11*q12;
end
...
q02=exp(-(D_d*(n*pi/L)^2+eta_d)*s)-exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52));
q03=1/(D_d*(n*pi/L)^2+eta_d);
q0=q01*q02*q03;
q11=1/(D_d*(n*pi/L)^2+eta_d);
q12=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52))*b1/d^2*(t52-t53)^2;
...
q1=q11*(q131+q132+q133+q134+q12/(D_d*(n*pi/L)^2+eta_d));
q21=-1/(D_d*(n*pi/L)^2+eta_d)^2;
q22=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52))*(2*b1/d^3*(t52-t53)^2+2*b1/d^2*(t52-t53));
...
q2=q21*(q231+q232+q22/(D_d*(n*pi/L)^2+eta_d));
q31=1/(D_d*(n*pi/L)^2+eta_d)^3;
q32=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52))*(8*b1/d^3*(t52-t53)+2*b1/d^2+2*b2/d^2*(1-2/d*(t52-t53)));
q33=4*b1/d^3*(s-t53)^2+2*b1/d^2*(s+(s-t52)^2/d)-4*b2/d^3*(s-t52)^2+2*b2/d^2*(s-(s-t53)^2/d);
q3=q31*(q33+q32/(D_d*(n*pi/L)^2+eta_d));
q41=-1/(D_d*(n*pi/L)^2+eta_d)^4;
q42=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52))*(12*b1/d^3-12*b2/d^3);
q43=(12*b1/d^3-12*b2/d^3)*s;
q4=q41*(q43+q42/(D_d*(n*pi/L)^2+eta_d));
q=q0+q1+q2+q3+q4;
end
...
q11=1/(D_d*(n*pi/L)^2+eta_d);
q12=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52))*b1/d^2*(t52-t53)^2;
q13=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t53))*(b2/d^2*(t53-t52)^2);
q14=1/(D_d*(n*pi/L)^2+eta_d);
q1=q11*(q12-q13)*q14;
q21=-1/(D_d*(n*pi/L)^2+eta_d)^2;
q22=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52))*(2*b1/d^3*(t52-t53)^2+2*b1/d^2*(t52-t53));
q23=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t53))*(-2*b2/d^3*(t53-t52)^2+2*b2/d^2*(t53-t52));
q24=1/(D_d*(n*pi/L)^2+eta_d);
q2=q21*(q22-q23)*q24;
q31=1/(D_d*(n*pi/L)^2+eta_d)^3;
q32=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52))*(8*b1/d^3*(t52-t53)+2*b1/d^2+2*b2/d^2*(1-2/d*(t52-t53)));
q33=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t53))*(2*b1/d^2*(1+2/d*(t53-t52))-8*b2/d^3*(t53-t52)+2*b2/d^2);
q34=1/(D_d*(n*pi/L)^2+eta_d);
q3=q31*(q32-q33)*q34;
q41=-1/(D_d*(n*pi/L)^2+eta_d)^4;
q42=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52))*(12*b1/d^3-12*b2/d^3);
q43=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t53))*(12*b1/d^3-12*b2/d^3);
q44=1/(D_d*(n*pi/L)^2+eta_d);
q4=q41*(q42-q43)*q44;
q51=b2/(D_d*(n*pi/L)^2+eta_d);
q52=s+exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t53))/(D_d*(n*pi/L)^2+eta_d);
q5=q51*q52;
q=q0+q1+q2+q3+q4+q5;
end
...
d=inter1;
q11=1/(D_d*(n*pi/L)^2+eta_d);
q12=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52))*(2*b1/d^3*(t52-t53)^2+2*b1/d^2*(t52-t53));
...
q1=q11*(q131+q132+q12/(D_d*(n*pi/L)^2+eta_d));
q21=-1/(D_d*(n*pi/L)^2+eta_d)^2;
q22=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52))*(8*b1/d^3*(t52-t53)+2*b1/d^2+2*b2/d^2*(1-2/d*(t52-t53)));
q23=4*b1/d^3*(s-t53)^2+2*b1/d^2*(s+(s-t52)^2/d)-4*b2/d^3*(s-t52)^2+2*b2/d^2*(s-(s-t53)^2/d);
q2=q21*(q23+q22/(D_d*(n*pi/L)^2+eta_d));
q31=1/(D_d*(n*pi/L)^2+eta_d)^3;
q32=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52))*(12*b1/d^3-12*b2/d^3);
...
q11=1/(D_d*(n*pi/L)^2+eta_d);
q12=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52))*(2*b1/d^3*(t52-t53)^2+2*b1/d^2*(t52-t53));
q13=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t53))*(-2*b2/d^3*(t53-t52)^2+2*b2/d^2*(t53-t52));
q14=1/(D_d*(n*pi/L)^2+eta_d);
q1=q11*(q12-q13)*q14;
q21=-1/(D_d*(n*pi/L)^2+eta_d)^2;
q22=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52))*(8*b1/d^3*(t52-t53)+2*b1/d^2+2*b2/d^2*(1-2/d*(t52-t53)));
q23=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t53))*(2*b1/d^2*(1+2/d*(t53-t52))-8*b2/d^3*(t53-t52)+2*b2/d^2);
q24=1/(D_d*(n*pi/L)^2+eta_d);
q2=q21*(q22-q23)*q24;
q31=1/(D_d*(n*pi/L)^2+eta_d)^3;
q32=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52))*(12*b1/d^3-12*b2/d^3);
q33=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t53))*(12*b1/d^3-12*b2/d^3);
q34=1/(D_d*(n*pi/L)^2+eta_d);
q3=q31*(q32-q33)*q34;
q=q1+q2+q3;
end
...
%积分函数五是因为fn包含边界函数d'(t)是阶梯函数，分段积分完成了后是一个定的关于t的积分，再对t积分后和积分函数三不一样，然后才是IL的值的一部分
if t>=t51 && t<t52
    q4=eta_d*(h_0_airjifen(t,n)-h_0_airjifen(0,n));
elseif t>=t52 && t<t53
    q41=eta_d*(h_0_airjifen(t52,n)-h_0_airjifen(0,n));
    q42=eta_d*(h_1_airjifen(t52,t53,t,n)-h_1_airjifen(t52,t53,t52,n));
    q43=h_3_airjifen(t52,t53,t,n)-h_3_airjifen(t52,t53,t52,n);
    q4=q41+q42+q43;
elseif t>=t53
    q41=eta_d*(h_0_airjifen(t52,n)-h_0_airjifen(0,n));
    q42=eta_d*(h_1_airjifen(t52,t53,t53,n)-h_1_airjifen(t52,t53,t52,n));
    q43=h_3_airjifen(t52,t53,t53,n)-h_3_airjifen(t52,t53,t52,n);
    q44=eta_d*(h_2_airjifen(t52,t53,t,n)-h_2_airjifen(t52,t53,t53,n));
...
q=fi_n*(1-exp(-(D_d*(n*pi/L)^2+eta_d)*t))/(D_d*(n*pi/L)^2+eta_d)+q5;
end
%第三部分
function q = A_4(x,t)
global A_0
...
q12=s+exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t51))/(D_d*(n*pi/L)^2+eta_d);
q=q11*q12;
end
%积分函数二，对应h4
...
d=inter1;
q11=1/(D_d*(n*pi/L)^2+eta_d);
q12=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52))*bi1/d^2*(t52-t53)^2;
...
q1=q11*(q131+q132+q133+q134+q12/(D_d*(n*pi/L)^2+eta_d));
q21=-1/(D_d*(n*pi/L)^2+eta_d)^2;
q22=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52))*(2*bi1/d^3*(t52-t53)^2+2*bi1/d^2*(t52-t53));
...
q2=q21*(q231+q232+q22/(D_d*(n*pi/L)^2+eta_d));
q31=1/(D_d*(n*pi/L)^2+eta_d)^3;
q32=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52))*(8*bi1/d^3*(t52-t53)+2*bi1/d^2+2*bi2/d^2*(1-2/d*(t52-t53)));
q33=4*bi1/d^3*(s-t53)^2+2*bi1/d^2*(s+(s-t52)^2/d)-4*bi2/d^3*(s-t52)^2+2*bi2/d^2*(s-(s-t53)^2/d);
q3=q31*(q33+q32/(D_d*(n*pi/L)^2+eta_d));
q41=-1/(D_d*(n*pi/L)^2+eta_d)^4;
q42=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52))*(12*bi1/d^3-12*bi2/d^3);
...
d=inter1;
q11=1/(D_d*(n*pi/L)^2+eta_d);
q12=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52))*(2*bi1/d^3*(t52-t53)^2+2*bi1/d^2*(t52-t53));
...
q1=q11*(q131+q132+q12/(D_d*(n*pi/L)^2+eta_d));
q21=-1/(D_d*(n*pi/L)^2+eta_d)^2;
q22=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52))*(8*bi1/d^3*(t52-t53)+2*bi1/d^2+2*bi2/d^2*(1-2/d*(t52-t53)));
q23=4*bi1/d^3*(s-t53)^2+2*bi1/d^2*(s+(s-t52)^2/d)-4*bi2/d^3*(s-t52)^2+2*bi2/d^2*(s-(s-t53)^2/d);
q2=q21*(q23+q22/(D_d*(n*pi/L)^2+eta_d));
q31=1/(D_d*(n*pi/L)^2+eta_d)^3;
q32=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52))*(12*bi1/d^3-12*bi2/d^3);
...
d=inter1;
q11=bi/(D_d*(n*pi/L)^2+eta_d);
q12=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t51))-exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52));
q13=1/(D_d*(n*pi/L)^2+eta_d);
q=q11*q12*q13;
end
%积分函数二，对应h4
...
q11=1/(D_d*(n*pi/L)^2+eta_d);
q12=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52))*bi1/d^2*(t52-t53)^2;
q13=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t53))*(bi2/d^2*(t53-t52)^2);
q14=1/(D_d*(n*pi/L)^2+eta_d);
q1=q11*(q12-q13)*q14;
q21=-1/(D_d*(n*pi/L)^2+eta_d)^2;
q22=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52))*(2*bi1/d^3*(t52-t53)^2+2*bi1/d^2*(t52-t53));
q23=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t53))*(-2*bi2/d^3*(t53-t52)^2+2*bi2/d^2*(t53-t52));
q24=1/(D_d*(n*pi/L)^2+eta_d);
q2=q21*(q22-q23)*q24;
q31=1/(D_d*(n*pi/L)^2+eta_d)^3;
q32=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52))*(8*bi1/d^3*(t52-t53)+2*bi1/d^2+2*bi2/d^2*(1-2/d*(t52-t53)));
q33=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t53))*(2*bi1/d^2*(1+2/d*(t53-t52))-8*bi2/d^3*(t53-t52)+2*bi2/d^2);
q34=1/(D_d*(n*pi/L)^2+eta_d);
q3=q31*(q32-q33)*q34;
q41=-1/(D_d*(n*pi/L)^2+eta_d)^4;
q42=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52))*(12*bi1/d^3-12*bi2/d^3);
q43=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t53))*(12*bi1/d^3-12*bi2/d^3);
q44=1/(D_d*(n*pi/L)^2+eta_d);
q4=q41*(q42-q43)*q44;
q=q1+q2+q3+q4;
end
...
q11=1/(D_d*(n*pi/L)^2+eta_d);
q12=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52))*(2*bi1/d^3*(t52-t53)^2+2*bi1/d^2*(t52-t53));
q13=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t53))*(-2*bi2/d^3*(t53-t52)^2+2*bi2/d^2*(t53-t52));
q14=1/(D_d*(n*pi/L)^2+eta_d);
q1=q11*(q12-q13)*q14;
q21=-1/(D_d*(n*pi/L)^2+eta_d)^2;
q22=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52))*(8*bi1/d^3*(t52-t53)+2*bi1/d^2+2*bi2/d^2*(1-2/d*(t52-t53)));
q23=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t53))*(2*bi1/d^2*(1+2/d*(t53-t52))-8*bi2/d^3*(t53-t52)+2*bi2/d^2);
q24=1/(D_d*(n*pi/L)^2+eta_d);
q2=q21*(q22-q23)*q24;
q31=1/(D_d*(n*pi/L)^2+eta_d)^3;
q32=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t52))*(12*bi1/d^3-12*bi2/d^3);
q33=exp(-(D_d*(n*pi/L)^2+eta_d)*(s-t53))*(12*bi1/d^3-12*bi2/d^3);
q34=1/(D_d*(n*pi/L)^2+eta_d);
q3=q31*(q32-q33)*q34;
q=q1+q2+q3;
end
...
if aa3==0
        q1=eta_d*(jifen_p1i_air(t5(1),t,n,b(1))-jifen_p1i_air(t5(1),t5(1),n,b(1)));
elseif aa3==1
    if aa4==0
    q111=eta_d*(jifen_p1i_air(t5(1),t5(2),n,b(1))-jifen_p1i_air(t5(1),t5(1),n,b(1)));
    q112=eta_d*(jifen_q1i_air(t5(1),t5(2),t,n,b(1))-jifen_q1i_air(t5(1),t5(2),t5(2),n,b(1)));
    q12=eta_d*(jifen_p2i_air(t5(2),t5(3),t,n,b(1),b(2))-jifen_p2i_air(t5(2),t5(3),t5(2),n,b(1),b(2)));
    q13=(jifen_p3i_air(t5(2),t5(3),t,n,b(1),b(2))-jifen_p3i_air(t5(2),t5(3),t5(2),n,b(1),b(2)));
    q1=q111+q112+q12+q13;
    else
    q111=eta_d*(jifen_p1i_air(t5(1),t5(2),n,b(1))-jifen_p1i_air(t5(1),t5(1),n,b(1)));
    q112=eta_d*(jifen_q1i_air(t5(1),t5(2),t,n,b(1))-jifen_q1i_air(t5(1),t5(2),t5(2),n,b(1)));
    q113=eta_d*(jifen_p1i_air(t5(3),t,n,b(2))-jifen_p1i_air(t5(3),t5(3),n,b(2)));
    q121=eta_d*(jifen_p2i_air(t5(2),t5(3),t5(3),n,b(1),b(2))-jifen_p2i_air(t5(2),t5(3),t5(2),n,b(1),b(2)));
    q122=eta_d*(jifen_q2i_air(t5(2),t5(3),t,n,b(1),b(2))-jifen_q2i_air(t5(2),t5(3),t5(3),n,b(1),b(2)));
    ...
    if aa4==0
        q111=q111+eta_d*(jifen_p1i_air(t5(1),t5(2),n,b(1))-jifen_p1i_air(t5(1),t5(1),n,b(1)));
        q112=q112+eta_d*(jifen_q1i_air(t5(1),t5(2),t,n,b(1))-jifen_q1i_air(t5(1),t5(2),t5(2),n,b(1)));
        for i=1:1:aa3-1
            q121=q121+eta_d*(jifen_p2i_air(t5(i*2),t5(i*2+1),t5(i*2+1),n,b(i),b(i+1))-jifen_p2i_air(t5(i*2),t5(i*2+1),t5(i*2),n,b(i),b(i+1)));
            q122=q122+eta_d*(jifen_q2i_air(t5(i*2),t5(i*2+1),t,n,b(i),b(i+1))-jifen_q2i_air(t5(i*2),t5(i*2+1),t5(i*2+1),n,b(i),b(i+1)));
            ...
            q111=q111+eta_d*(jifen_p1i_air(t5(i*2+1),t5(i*2+2),n,b(i+1))-jifen_p1i_air(t5(i*2+1),t5(i*2+1),n,b(i+1)));
            q112=q112+eta_d*(jifen_q1i_air(t5(i*2+1),t5(i*2+2),t,n,b(i+1))-jifen_q1i_air(t5(i*2+1),t5(i*2+2),t5(i*2+2),n,b(i+1)));
        end
            q123=eta_d*(jifen_p2i_air(t5(aa2),t5(aa2+1),t,n,b(aa3),b(aa3+1))-jifen_p2i_air(t5(aa2),t5(aa2+1),t5(aa2),n,b(aa3),b(aa3+1)));
        ...
        for i=1:1:aa3-1         
            ...
            q121=q121+eta_d*(jifen_p2i_air(t5(aa3*2),t5(aa3*2+1),t5(aa3*2+1),n,b(aa3),b(aa3+1))-jifen_p2i_air(t5(aa3*2),t5(aa3*2+1),t5(aa3*2),n,b(aa3),b(aa3+1)));
            q122=q122+eta_d*(jifen_q2i_air(t5(aa3*2),t5(aa3*2+1),t,n,b(aa3),b(aa3+1))-jifen_q2i_air(t5(aa3*2),t5(aa3*2+1),t5(aa3*2+1),n,b(aa3),b(aa3+1)));
            ...
            q113=eta_d*(jifen_p1i_air(t5(aa2),t,n,b(aa3+1))-jifen_p1i_air(t5(aa2),t5(aa2),n,b(aa3+1)));
            q1=q111+q112+q113+q121+q122+q131+q132;
    end
end
...
% if t>=t51 && t<t52
%     q1=eta_d*(jifen_p1i_air(t51,t,n,b1)-jifen_p1i_air(t51,t51,n,b1));
% elseif t>=t52 && t<t53
%     q111=eta_d*(jifen_p1i_air(t51,t52,n,b1)-jifen_p1i_air(t51,t51,n,b1));
%     q112=eta_d*(jifen_q1i_air(t51,t52,t,n,b1)-jifen_q1i_air(t51,t52,t52,n,b1));
%     q12=eta_d*(jifen_p2i_air(t52,t53,t,n,b1,b2)-jifen_p2i_air(t52,t53,t52,n,b1,b2));
%     q13=(jifen_p3i_air(t52,t53,t,n,b1,b2)-jifen_p3i_air(t52,t53,t52,n,b1,b2));
%     q1=q111+q112+q12+q13;
% elseif t>=t53 && t<t54
%     q111=eta_d*(jifen_p1i_air(t51,t52,n,b1)-jifen_p1i_air(t51,t51,n,b1));
%     q112=eta_d*(jifen_q1i_air(t51,t52,t,n,b1)-jifen_q1i_air(t51,t52,t52,n,b1));
%     q113=eta_d*(jifen_p1i_air(t53,t,n,b2)-jifen_p1i_air(t53,t53,n,b2));
%     q121=eta_d*(jifen_p2i_air(t52,t53,t53,n,b1,b2)-jifen_p2i_air(t52,t53,t52,n,b1,b2));
%     q122=eta_d*(jifen_q2i_air(t52,t53,t,n,b1,b2)-jifen_q2i_air(t52,t53,t53,n,b1,b2));
...
%     q111=eta_d*(jifen_p1i_air(t51,t52,n,b1)-jifen_p1i_air(t51,t51,n,b1));
%     q112=eta_d*(jifen_q1i_air(t51,t52,t,n,b1)-jifen_q1i_air(t51,t52,t52,n,b1));
%     q113=eta_d*(jifen_p1i_air(t53,t54,n,b2)-jifen_p1i_air(t53,t53,n,b2));
%     q114=eta_d*(jifen_q1i_air(t53,t54,t,n,b2)-jifen_q1i_air(t53,t54,t54,n,b2));
%     q121=eta_d*(jifen_p2i_air(t52,t53,t53,n,b1,b2)-jifen_p2i_air(t52,t53,t52,n,b1,b2));
%     q122=eta_d*(jifen_q2i_air(t52,t53,t,n,b1,b2)-jifen_q2i_air(t52,t53,t53,n,b1,b2));
%     q123=eta_d*(jifen_p2i_air(t54,t55,t,n,b2,b3)-jifen_p2i_air(t54,t55,t54,n,b2,b3));
%     q131=(jifen_p3i_air(t52,t53,t53,n,b1,b2)-jifen_p3i_air(t52,t53,t52,n,b1,b2));
%     q132=(jifen_q3i_air(t52,t53,t,n,b1,b2)-jifen_q3i_air(t52,t53,t53,n,b1,b2));
...
%     q113=eta_d*(jifen_p1i_air(t53,t54,n,b2)-jifen_p1i_air(t53,t53,n,b2));
%     q114=eta_d*(jifen_q1i_air(t53,t54,t,n,b2)-jifen_q1i_air(t53,t54,t54,n,b2));
%     q115=eta_d*(jifen_p1i_air(t55,t,n,b3)-jifen_p1i_air(t55,t55,n,b3));
%     q121=eta_d*(jifen_p2i_air(t52,t53,t53,n,b1,b2)-jifen_p2i_air(t52,t53,t52,n,b1,b2));
%     q122=eta_d*(jifen_q2i_air(t52,t53,t,n,b1,b2)-jifen_q2i_air(t52,t53,t53,n,b1,b2));
%     q123=eta_d*(jifen_p2i_air(t54,t55,t55,n,b2,b3)-jifen_p2i_air(t54,t55,t54,n,b2,b3));
%     q124=eta_d*(jifen_q2i_air(t54,t55,t,n,b2,b3)-jifen_q2i_air(t54,t55,t55,n,b2,b3));
%     q131=(jifen_p3i_air(t52,t53,t53,n,b1,b2)-jifen_p3i_air(t52,t53,t52,n,b1,b2));
%     q132=(jifen_q3i_air(t52,t53,t,n,b1,b2)-jifen_q3i_air(t52,t53,t53,n,b1,b2));
...
%     q113=eta_d*(jifen_p1i_air(t53,t54,n,b2)-jifen_p1i_air(t53,t53,n,b2));
%     q114=eta_d*(jifen_q1i_air(t53,t54,t,n,b2)-jifen_q1i_air(t53,t54,t54,n,b2));
%     q115=eta_d*(jifen_p1i_air(t55,t56,n,b3)-jifen_p1i_air(t55,t55,n,b3));
%     q116=eta_d*(jifen_q1i_air(t55,t56,t,n,b3)-jifen_q1i_air(t55,t56,t56,n,b3));
%     q121=eta_d*(jifen_p2i_air(t52,t53,t53,n,b1,b2)-jifen_p2i_air(t52,t53,t52,n,b1,b2));
%     q122=eta_d*(jifen_q2i_air(t52,t53,t,n,b1,b2)-jifen_q2i_air(t52,t53,t53,n,b1,b2));
%     q123=eta_d*(jifen_p2i_air(t54,t55,t55,n,b2,b3)-jifen_p2i_air(t54,t55,t54,n,b2,b3));
%     q124=eta_d*(jifen_q2i_air(t54,t55,t,n,b2,b3)-jifen_q2i_air(t54,t55,t55,n,b2,b3));
%     q125=eta_d*(jifen_p2i_air(t56,t57,t,n,b3,b4)-jifen_p2i_air(t56,t57,t56,n,b3,b4));
%     q131=(jifen_p3i_air(t52,t53,t53,n,b1,b2)-jifen_p3i_air(t52,t53,t52,n,b1,b2));
%     q132=(jifen_q3i_air(t52,t53,t,n,b1,b2)-jifen_q3i_air(t52,t53,t53,n,b1,b2));
%     q133=(jifen_p3i_air(t54,t55,t55,n,b2,b3)-jifen_p3i_air(t54,t55,t54,n,b2,b3));
%     q134=(jifen_q3i_air(t54,t55,t,n,b2,b3)-jifen_q3i_air(t54,t55,t55,n,b2,b3));
...
%     q115=eta_d*(jifen_p1i_air(t55,t56,n,b3)-jifen_p1i_air(t55,t55,n,b3));
%     q116=eta_d*(jifen_q1i_air(t55,t56,t,n,b3)-jifen_q1i_air(t55,t56,t56,n,b3));
%     q117=eta_d*(jifen_p1i_air(t57,t,n,b4)-jifen_p1i_air(t57,t57,n,b4));
%     q121=eta_d*(jifen_p2i_air(t52,t53,t53,n,b1,b2)-jifen_p2i_air(t52,t53,t52,n,b1,b2));
%     q122=eta_d*(jifen_q2i_air(t52,t53,t,n,b1,b2)-jifen_q2i_air(t52,t53,t53,n,b1,b2));
%     q123=eta_d*(jifen_p2i_air(t54,t55,t55,n,b2,b3)-jifen_p2i_air(t54,t55,t54,n,b2,b3));
%     q124=eta_d*(jifen_q2i_air(t54,t55,t,n,b2,b3)-jifen_q2i_air(t54,t55,t55,n,b2,b3));
%     q125=eta_d*(jifen_p2i_air(t56,t57,t57,n,b3,b4)-jifen_p2i_air(t56,t57,t56,n,b3,b4));
%     q126=eta_d*(jifen_q2i_air(t56,t57,t,n,b3,b4)-jifen_q2i_air(t56,t57,t57,n,b3,b4));
%     q131=(jifen_p3i_air(t52,t53,t53,n,b1,b2)-jifen_p3i_air(t52,t53,t52,n,b1,b2));
%     q132=(jifen_q3i_air(t52,t53,t,n,b1,b2)-jifen_q3i_air(t52,t53,t53,n,b1,b2));
%     q133=(jifen_p3i_air(t54,t55,t55,n,b2,b3)-jifen_p3i_air(t54,t55,t54,n,b2,b3));
%     q134=(jifen_q3i_air(t54,t55,t,n,b2,b3)-jifen_q3i_air(t54,t55,t55,n,b2,b3));
...
fi_n=(2*d_initial*L^2/n/pi*(-1)^(n+1)+4*d_initial*L^2/(n*pi)^3*((-1)^n-1)+d_0*(2*L)/n/pi*(-1)^n);
q4=2*L/(n*pi)*(-1)^n*q1;
q=fi_n*(1-exp(-(D_d*(n*pi/L)^2+eta_d)*t))/(D_d*(n*pi/L)^2+eta_d)+q4;
end
