...
% IGF1_0=zeros(1,1001);
y0=zeros(4,1);
EGFR=ones(1,101)*0.906171095;
ERK=ones(1,101)*0.496913113;
IGF1R=ones(1,101)*0.027626518;
AKT=ones(1,101)*0.174679186;
...
IGF1R_I=0;
C_T_1=zeros(101,101);
C_M1_1=zeros(101,101);
C_M2_1=zeros(101,101);
CSF1_1=zeros(101,101);
EGF_1=zeros(101,101);
IGF1_1=zeros(101,101);
C_T_1(1,:)=C_T_0; 
C_M1_1(1,:)=C_M1_0;
C_M2_1(1,:)=C_M2_0;
CSF1_1(1,:)=CSF1_0;
...
%     R7=V1*EGF/(K11+EGF)/(1+u(8)/K12)/(1+EGFR_I/K13)*(1-u(7))-d1*u(7);
%     R8=a*(1+V21*u(7)^n/(K21^n+u(7)^n))*(1+V22*u(3)/(K22+u(9)))/(1+u(10)/K23)*(1-u(8))-d2*u(8);
%     R9=V3*IGF1/(K31+IGF1)/(1+u(8)/K32)/(1+IGF1R_I/K33)*(1-u(9))-d3*u(9);
