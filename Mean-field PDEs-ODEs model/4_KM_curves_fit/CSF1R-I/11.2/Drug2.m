...
% if t>=t51 && t<t52
%     q1=eta1*p1i_air(t51,t,n,b1);
% elseif t>=t52 && t<t53
%     q11=eta1*q1i_air(t51,t52,t,n,b1);
%     q1=q11+eta1*p2i_air(t52,t53,t,n,b1,b2)+p3i_air(t52,t53,t,n,b1,b2);
% elseif t>=t53 && t<t54
%     q11=eta1*q1i_air(t51,t52,t,n,b1);
%     q12=eta1*q2i_air(t52,t53,t,n,b1,b2);
%     q13=q3i_air(t52,t53,t,n,b1,b2);
%     q1=q11+q12+q13+eta1*p1i_air(t53,t,n,b2);
% elseif t>=t54 && t<t55
%     q11=eta1*(q1i_air(t51,t52,t,n,b1)+q1i_air(t53,t54,t,n,b2));
%     q12=eta1*q2i_air(t52,t53,t,n,b1,b2);
%     q13=q3i_air(t52,t53,t,n,b1,b2);
%     q1=q11+q12+q13+eta1*p2i_air(t54,t55,t,n,b2,b3)+p3i_air(t54,t55,t,n,b2,b3);
% elseif t>=t55 && t<t56
%     q11=eta1*(q1i_air(t51,t52,t,n,b1)+q1i_air(t53,t54,t,n,b2));
%     q12=eta1*(q2i_air(t52,t53,t,n,b1,b2)+q2i_air(t54,t55,t,n,b2,b3));
%     q13=(q3i_air(t52,t53,t,n,b1,b2)+q3i_air(t54,t55,t,n,b2,b3));
%     q1=q11+q12+q13+eta1*p1i_air(t55,t,n,b3);
% elseif t>=t56 && t<t57
%     q11=eta1*(q1i_air(t51,t52,t,n,b1)+q1i_air(t53,t54,t,n,b2)+q1i_air(t55,t56,t,n,b3));
%     q12=eta1*(q2i_air(t52,t53,t,n,b1,b2)+q2i_air(t54,t55,t,n,b2,b3));
%     q13=(q3i_air(t52,t53,t,n,b1,b2)+q3i_air(t54,t55,t,n,b2,b3));
%     q1=q11+q12+q13+eta1*p2i_air(t56,t57,t,n,b3,b4)+p3i_air(t56,t57,t,n,b3,b4);
% elseif t>=t57 && t<=t58
%     q11=eta1*(q1i_air(t51,t52,t,n,b1)+q1i_air(t53,t54,t,n,b2)+q1i_air(t55,t56,t,n,b3));
%     q12=eta1*(q2i_air(t52,t53,t,n,b1,b2)+q2i_air(t54,t55,t,n,b2,b3)+q2i_air(t56,t57,t,n,b3,b4));
%     q13=(q3i_air(t52,t53,t,n,b1,b2)+q3i_air(t54,t55,t,n,b2,b3)+q3i_air(t56,t57,t,n,b3,b4));
%     q1=q11+q12+q13+eta1*p1i_air(t57,t,n,b4);
% else
%     msg='Error occured';
%     error(msg)
% end
