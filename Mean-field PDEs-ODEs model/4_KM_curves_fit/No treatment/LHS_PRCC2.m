...
global eta_d D_d %药物
global dmax1 dmax2 K_CSF1RI K_Gal9I K_A B_CSF1RI A_0 B_3 S_IGF1 D_T
...
select_CSF1R_I=0;%PTEN=1
select_Gal9_I=1;%PTEN=0
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Parameters
if select_CSF1R_I~=0
    Parameter=[alpha_AKT alpha_ERK B_CSF1 B_CSF1RI B_M1M2 K1 K2 K3 K4 K5 K_CSF1RI K_A d_TM1 r_T B_3 S_IGF1 D_T];%14
else
...
if select_CSF1R_I~=0
    ...
    S_IGF1_1=D(:,16);
    D_T_1=D(:,17);
    Parameter_1=[alpha_AKT_1 alpha_ERK_1 B_CSF1_1 B_CSF1RI_1 B_M1M2_1 K1_1 K2_1 K3_1 K4_1 K5_1 K_CSF1RI_1 K_A_1 d_TM1_1 r_T_1 B_3_1 S_IGF1_1 D_T_1];%14
    Para_label={'{\alpha}_{AKT}','{\alpha}_{ERK}','B_{CSF1}','B_{CSF1RI}','B_{M1M2}','K1','K2','K3','K4','K5','K_{CSF1RI}','K_A','d_{TM}','r_T','S_A','S_IGF1' 'D_T'};
else
    % %%% Ranking
    alpha_AKT_1=D(:,1);
    alpha_ERK_1=D(:,2);
...
save('Pvalue_data.mat','PCC_RG','Pvalue_RG');
p_RG=Pvalue_RG
p_K=Pvalue_K
figure,
