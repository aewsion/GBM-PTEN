...
p = inputParser;
p.addParameter('AbsTol',[],@validateAbsTol);
p.addParameter('RelTol',[],@validateRelTol);
p.addParameter('MaxIntervalCount',650,@validateMaxIntervalCount);
p.addParameter('Waypoints',[],@validateWaypoints);
p.parse(varargin{:});
