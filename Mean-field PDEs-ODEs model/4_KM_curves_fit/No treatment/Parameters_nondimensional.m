...
r_T_0=2.41*10^(-5)/2.65;  %肿瘤细胞的基础增值率
...
d_TM1_0=2*10^(-5)/1.65;%PDE_Para(6) 0.01

beta_CSF1=4.6875*10^(-6);
beta_Gal9=1.75*10^(-5); %Gal9
% beta_M1M2=1.25*10^(-6);
beta_M1M2=1.25*10^(-6);% PDE_Para(1) 0.715

V_Gal9=2.5*10^(-5);
S_Gal9=S_Gal9_0*V_Gal9;

K1=1.92*10^(-10);%CSF1
K2=0.15*10^(-12);%Gal9_en PDE_Para(2) 0.4801
% K2=0.15;
K3=0.7;%Gal9 PDE_Para(3) 3.7318
K4=0.9502;%ERK 0.9502
% K4=PDE_Para(4);%ERK 0.9502
K5=0.015;%AKT  PDE_Para(5) 0.0492

S_A=1.2905*10^(-7)*150/340;
...
B_M1M2=D_IGF1/d_IGF1/D_T*beta_M1M2*20;
B_CSF1RI=beta_M1M2*8;%最终模型用的这个参数
epsilon=D_T/D_IGF1;
M1=d_CSF1/d_IGF1;
M2=d_Gal9/d_IGF1;
M3=d_EGF/d_IGF1;
