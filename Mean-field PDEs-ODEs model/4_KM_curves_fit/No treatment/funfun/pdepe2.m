...
L2=100;
[pL,qL,pR,qR] = feval(bc,xmesh(1),y0(1:npde,1),xmesh(nx),y0(1:npde,nx),t(1),sum(y0(5,:))/(L2+1),varargin{:});
...
%---------------------------------------------------------------------------
    function dudt = pdeodes(tnow,y)
        ...
        [pL,qL,pR,qR] = feval(bc,xmesh(1),u(:,1),xmesh(nx),u(:,nx),tnow,sum(u(5,:))/(L2+1),varargin{:});
